...
I use this for hackathons, to test collecting metrics, logs and traces on Openshift - Using Openshift data foundation managed noobaa as the storage backend.
